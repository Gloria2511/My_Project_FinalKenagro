...
import com.gloria.myprojectfinalkenagro.Activity.CartListActivity;
...
public class CartListAdaptor extends RecyclerView.Adapter<CartListAdaptor.ViewHolder> {
    ...
    private CartListActivity managementCart;
    private ChangeNumberItemsListener changeNumberItemsListener;

    public CartListAdaptor(ArrayList<FoodDomain> foodDomains, CartListActivity managementCart, ChangeNumberItemsListener changeNumberItemsListener) {
